...
(function (global) {
  ...
  /**
   * Clears all recorded SVG data without ending the recording session.
   * If beginRecordSvg() has not been called, this function does nothing.
   */
  p5plotSvg.clearRecordSvg = function () {
    if (!_bRecordingSvgBegun) {
      return;
    }
    _commands = [];
  ...
  */
  ...
  global.clearRecordSvg = p5plotSvg.clearRecordSvg;
